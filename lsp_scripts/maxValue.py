...
if __name__ == '__main__':
    ...
    maxValue = np.zeros((test_data_size, 14)).astype(np.float32)
    ...
    for i in range(0, test_data_size, TEST_BATCH_SIZE):
        ...
        for j in range(1,15):
            ...
            maxValue[i,j-1] = np.max(one_joint_map)
    ...
    #sio.savemat('ests.mat', {'ests':ests})
    sio.savemat('maxValue.mat', {'maxValue':maxValue})
